    ...
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu">
          <a class="dropdown-item" href="#">Chess basics</a>
          <a class="dropdown-item" href="#">Puzzles</a>
          <a class="dropdown-item" href="#">Openings</a>
          <a class="dropdown-item" href="#">Endgame</a>
        </div>
      </li>
      <li class="nav-item dropdown">
        <a class="nav-link dropdown-toggle" data-toggle="dropdown"
          aria-haspopup="true" aria-expanded="false">Watch</a>
        <div class="dropdown-menu">
          <a class="dropdown-item" href="#">Current games</a>
          <a class="dropdown-item" href="#">Streamers</a>
        </div>
      </li>
      <li class="nav-item dropdown">
        <a class="nav-link dropdown-toggle" data-toggle="dropdown"
    ...
    <div class="navbar-end">
      <div class="navbar-item">
        <div class="control has-icons-right">
          <input class="input" type="search" placeholder="@Username">
